...
dependencies {
    ...
    "testImplementation"("com.google.firebase:firebase-iid:20.2.4")
    ...
    "androidTestImplementation"("com.google.firebase:firebase-core:17.5.0")
    ...
    "androidTestImplementation"("com.google.firebase:firebase-iid:20.2.4")
    "androidTestImplementation"("com.google.firebase:firebase-firestore:21.6.0")
